...
class Shape27 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get lastSynced =>
      columnsByName['last_synced']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get remoteLastRead =>
      columnsByName['remote_last_read']! as i1.GeneratedColumn<int>;
}
...
final class Schema9 extends i0.VersionedSchema {
  ...
  late final Shape30 seriesMetadata = Shape30(
    source: i0.VersionedTable(
      entityName: 'series_metadata',
      withoutRowId: false,
      isStrict: false,
  ...
  late final Shape31 people = Shape31(
    source: i0.VersionedTable(
      entityName: 'people',
      withoutRowId: false,
      isStrict: false,
  ...
  late final Shape7 seriesPeopleRoles = Shape7(
    source: i0.VersionedTable(
      ...
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(series_metadata_id, person_id, role)'],
      columns: [_column_33, _column_34, _column_35],
      attachedDatabase: database,
    ),
    alias: null,
  ...
  late final Shape32 chapters = Shape32(
    source: i0.VersionedTable(
      entityName: 'chapters',
      withoutRowId: false,
      isStrict: false,
  ...
  late final Shape33 chapterPeopleRoles = Shape33(
    source: i0.VersionedTable(
      entityName: 'chapter_people_roles',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(chapter_id, person_id, role)'],
      columns: [_column_56, _column_34, _column_35],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape34 chapterGenres = Shape34(
    source: i0.VersionedTable(
      entityName: 'chapter_genres',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(chapter_id, genre_id)'],
      columns: [_column_56, _column_36],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape35 chapterTags = Shape35(
    source: i0.VersionedTable(
      entityName: 'chapter_tags',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(chapter_id, tag_id)'],
      columns: [_column_56, _column_37],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
class Shape30 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get language =>
      columnsByName['language']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get maxCount =>
      columnsByName['max_count']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get totalCount =>
      columnsByName['total_count']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get publicationStatus =>
      columnsByName['publication_status']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get webLinks =>
      columnsByName['web_links']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get lastUpdated =>
      columnsByName['last_updated']! as i1.GeneratedColumn<int>;
}
...
final class Schema10 extends i0.VersionedSchema {
  ...
  late final Shape36 fonts = Shape36(
    source: i0.VersionedTable(
      entityName: 'fonts',
      withoutRowId: false,
      isStrict: false,
...
class Shape36 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get id =>
      columnsByName['id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get family =>
      columnsByName['family']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get name =>
      columnsByName['name']! as i1.GeneratedColumn<String>;
...
final class Schema11 extends i0.VersionedSchema {
  ...
  late final Shape39 smartFilterSeries = Shape39(
    source: i0.VersionedTable(
      entityName: 'smart_filter_series',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(smart_filter_id, series_id)'],
      columns: [_column_104, _column_25],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape40 smartFilterReadingList = Shape40(
    source: i0.VersionedTable(
      entityName: 'smart_filter_reading_list',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(smart_filter_id, reading_list_id)'],
      columns: [_column_104, _column_83],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape41 smartFilterPerson = Shape41(
    source: i0.VersionedTable(
      entityName: 'smart_filter_person',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(smart_filter_id, person_id)'],
      columns: [_column_104, _column_105],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
final class Schema12 extends i0.VersionedSchema {
  ...
  late final Shape42 serverFonts = Shape42(
    source: i0.VersionedTable(
      entityName: 'server_fonts',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(id)'],
      columns: [
...
final class Schema13 extends i0.VersionedSchema {
  ...
  late final Shape43 chapters = Shape43(
    source: i0.VersionedTable(
      entityName: 'chapters',
      withoutRowId: false,
      isStrict: false,
...
class Shape43 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get totalReads =>
      columnsByName['total_reads']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get remotePagesRead =>
      columnsByName['remote_pages_read']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get remoteLastRead =>
      columnsByName['remote_last_read']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get created =>
      columnsByName['created']! as i1.GeneratedColumn<int>;
